...
_58 packages. Figures refreshed 2026-09-09._
...
| [theodo-group/llphant](https://github.com/LLPhant/LLPhant) | 1.7K | 498.7K | Full generative AI toolkit for PHP: chat, embeddings, vector stores and question answering. Framework agnostic with Laravel bindings. |
| [cognesy/instructor-php](https://github.com/cognesy/instructor-php) | 327 | 135.1K | Structured output done properly. Define a PHP class, get back a validated instance instead of hand-parsing JSON out of a string. |
| [moe-mizrak/laravel-openrouter](https://github.com/moe-mizrak/laravel-openrouter) | 158 | 235.3K | OpenRouter integration, which gets you several hundred models through a single credential. |
| [neuron-core/neuron-laravel](https://github.com/neuron-core/neuron-laravel) | 120 | 60.7K | Official Laravel SDK for Neuron, covering agents, RAG and workflows behind one interface. |
...
| [google-gemini-php/laravel](https://github.com/google-gemini-php/laravel) `popular` | 640 | 727.8K | Gemini for Laravel from the same team behind the OpenAI client, so the API shape will feel familiar. |
| [cloudstudio/ollama-laravel](https://github.com/cloudstudio/ollama-laravel) `popular` | 478 | 144.8K | Talk to locally hosted models through Ollama. The obvious starting point if you want inference that never leaves your machine. |
| [openai-php/client](https://github.com/openai-php/client) | 5.8K | 32.8M | The framework-agnostic core that the Laravel adapter wraps. Use it directly outside Laravel. |
| [deepseek-php/deepseek-php-client](https://github.com/deepseek-php/deepseek-php-client) | 474 | 106.6K | Community-driven DeepSeek client, useful when cost per token is the deciding factor. |
...
| [anthropic-ai/sdk](https://github.com/anthropics/anthropic-sdk-php) | 177 | 1.5M | Official Anthropic PHP SDK for the Claude API. |
| [mozex/anthropic-laravel](https://github.com/mozex/anthropic-laravel) | 74 | 427.9K | Laravel integration for Anthropic: facade, config publishing and streaming. |
| [claude-php/claude-php-sdk-laravel](https://github.com/claude-php/Claude-PHP-SDK-Laravel) | 52 | 30.7K | Community Claude SDK with a Laravel service provider. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [laravel/mcp](https://github.com/laravel/mcp) `official` | 810 | 34.9M | First-party MCP server support from the Laravel core team. Routes, tools, resources and prompts declared the way you would declare anything else in Laravel. |
| [php-mcp/laravel](https://github.com/php-mcp/laravel) | 476 | 228.1K | Mature independent SDK. Attribute-driven tool discovery and multiple transports. Predates the official package and still ships features it lacks. |
| [opgginc/laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server) | 332 | 71.3K | Production-oriented server built around secure remote transports rather than stdio. |
| [kirschbaum-development/laravel-loop](https://github.com/kirschbaum-development/laravel-loop) | 133 | 20.1K | MCP server that exposes Eloquent models and app actions with an auth layer in front of them. |
| [lucianotonet/laravel-telescope-mcp](https://github.com/lucianotonet/laravel-telescope-mcp) | 23 | 43.7K | Puts Telescope entries in front of an agent so it can read your queries and exceptions while debugging. |
| [redberry/mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel) | 13 | 125.7K | The other direction: consume any configured MCP server from inside your Laravel app. |
| [mattiasgeniar/filament-mcp](https://github.com/mattiasgeniar/filament-mcp) | 11 | 1.6K | Exposes Filament resources over MCP. |
| [onelearningcommunity/laravel-model-explorer](https://github.com/One-Learning-Community/laravel-model-explorer) | 7 | 66.9K | Zero-config browser UI and MCP server for exploring Eloquent models and their relationships. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [maestroerror/laragent](https://github.com/MaestroError/LarAgent) `popular` | 643 | 205.5K | Agents as Laravel classes. Chat history, tools and per-agent configuration with very little ceremony. |
...
| [brynj-digital/laravel-scout-vectorize](https://github.com/brynj-digital/laravel-scout-vectorize) | 8 | 299 | Cloudflare Vectorize driver for Laravel Scout. |
| [droath/laravel-text-chunker](https://github.com/droath/laravel-text-chunker) | 3 | 735 | Strategy-based text chunking. Chunk quality decides retrieval quality, so this matters more than it looks. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [laravel/boost](https://github.com/laravel/boost) `official` | 3.6K | 33.2M | First-party. Feeds coding agents accurate, version-specific Laravel context plus app introspection tools. Install this before blaming the model. |
| [joshcirre/instruckt-laravel](https://github.com/joshcirre/instruckt-laravel) | 174 | 44K | Visual feedback loop so a coding agent can see the page it just changed. |
| [mischasigtermans/laravel-altitude](https://github.com/mischasigtermans/laravel-altitude) | 122 | 23.9K | Agent definitions tuned for the TALL stack. |
| [spatie/boost-spatie-guidelines](https://github.com/spatie/boost-spatie-guidelines) | 109 | 313.9K | Spatie house style as Boost guidelines, so generated code matches how the ecosystem actually writes Laravel. |
| [promptphp/deck](https://github.com/promptphp/deck) | 109 | 10K | Versioned, file-based prompt management. Treats prompts as reviewable artifacts instead of strings buried in a controller. |
| [spatie/guidelines-skills](https://github.com/spatie/guidelines-skills) | 90 | 172.5K | The same guidelines packaged as portable agent skills. |
| [mrpunyapal/laravel-auditor](https://github.com/MrPunyapal/laravel-auditor) | 46 | 3.6K | Read-only context tools plus an evidence-based audit methodology for reviewing an unfamiliar codebase. |
| [andreapollastri/larapilot](https://github.com/andreapollastri/larapilot) | 19 | 451 | Spec-driven workflow: discovery, backlog and planning before any code gets generated. |
| [sandermuller/package-boost-laravel](https://github.com/SanderMuller/package-boost-laravel) | 1 | 6.3K | Agent skills aimed specifically at people authoring Laravel packages. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [pestphp/pest-plugin-evals](https://github.com/pestphp/pest-plugin-evals) `official` | 5 | 69.7K | Evals as Pest tests. LLM-as-judge and semantic assertions running in the same suite as everything else. |
...
| [mischasigtermans/laravel-toon](https://github.com/mischasigtermans/laravel-toon) | 146 | 60.6K | TOON encoder and decoder wired into Laravel. |
| [helgesverre/toon](https://github.com/HelgeSverre/toon-php) | 130 | 310K | Token-Oriented Object Notation. Noticeably cheaper than JSON when you are stuffing structured data into a prompt. |
| [rajentrivedi/tokenizer-x](https://github.com/rajentrivedi/tokenizer-x) | 91 | 274.1K | Counts the tokens a prompt will cost across several model families. |
...
| [relaticle/ink](https://github.com/relaticle/ink) | 15 | 4.2K | Filament-native publishing that emits AI-citable article markup. |
...
| [eslam-reda-div/filament-copilot](https://github.com/eslam-reda-div/filament-copilot) | 43 | 17.9K | Drops an AI copilot panel into a Filament admin. |
| [cboxdk/statamic-mcp](https://github.com/cboxdk/statamic-mcp) | 36 | 30.5K | MCP server for Statamic v6, if your Laravel app happens to be a Statamic site. |
