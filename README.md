...
| [theodo-group/llphant](https://github.com/LLPhant/LLPhant) | 1.7K | 496.7K | Full generative AI toolkit for PHP: chat, embeddings, vector stores and question answering. Framework agnostic with Laravel bindings. |
| [cognesy/instructor-php](https://github.com/cognesy/instructor-php) | 327 | 135K | Structured output done properly. Define a PHP class, get back a validated instance instead of hand-parsing JSON out of a string. |
| [moe-mizrak/laravel-openrouter](https://github.com/moe-mizrak/laravel-openrouter) | 158 | 234.7K | OpenRouter integration, which gets you several hundred models through a single credential. |
| [neuron-core/neuron-laravel](https://github.com/neuron-core/neuron-laravel) | 120 | 60.4K | Official Laravel SDK for Neuron, covering agents, RAG and workflows behind one interface. |
...
| [google-gemini-php/laravel](https://github.com/google-gemini-php/laravel) `popular` | 640 | 724.8K | Gemini for Laravel from the same team behind the OpenAI client, so the API shape will feel familiar. |
| [cloudstudio/ollama-laravel](https://github.com/cloudstudio/ollama-laravel) `popular` | 478 | 144.5K | Talk to locally hosted models through Ollama. The obvious starting point if you want inference that never leaves your machine. |
| [openai-php/client](https://github.com/openai-php/client) | 5.8K | 32.7M | The framework-agnostic core that the Laravel adapter wraps. Use it directly outside Laravel. |
...
| [mozex/anthropic-laravel](https://github.com/mozex/anthropic-laravel) | 74 | 426.4K | Laravel integration for Anthropic: facade, config publishing and streaming. |
...
| [php-mcp/laravel](https://github.com/php-mcp/laravel) | 476 | 225.3K | Mature independent SDK. Attribute-driven tool discovery and multiple transports. Predates the official package and still ships features it lacks. |
...
| [lucianotonet/laravel-telescope-mcp](https://github.com/lucianotonet/laravel-telescope-mcp) | 23 | 43.3K | Puts Telescope entries in front of an agent so it can read your queries and exceptions while debugging. |
...
| [onelearningcommunity/laravel-model-explorer](https://github.com/One-Learning-Community/laravel-model-explorer) | 7 | 66.1K | Zero-config browser UI and MCP server for exploring Eloquent models and their relationships. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [maestroerror/laragent](https://github.com/MaestroError/LarAgent) `popular` | 642 | 205.1K | Agents as Laravel classes. Chat history, tools and per-agent configuration with very little ceremony. |
...
| [droath/laravel-text-chunker](https://github.com/droath/laravel-text-chunker) | 3 | 731 | Strategy-based text chunking. Chunk quality decides retrieval quality, so this matters more than it looks. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [laravel/boost](https://github.com/laravel/boost) `official` | 3.6K | 33M | First-party. Feeds coding agents accurate, version-specific Laravel context plus app introspection tools. Install this before blaming the model. |
...
| [promptphp/deck](https://github.com/promptphp/deck) | 110 | 9.9K | Versioned, file-based prompt management. Treats prompts as reviewable artifacts instead of strings buried in a controller. |
| [spatie/boost-spatie-guidelines](https://github.com/spatie/boost-spatie-guidelines) | 109 | 311.9K | Spatie house style as Boost guidelines, so generated code matches how the ecosystem actually writes Laravel. |
| [spatie/guidelines-skills](https://github.com/spatie/guidelines-skills) | 90 | 170.2K | The same guidelines packaged as portable agent skills. |
...
| Package | Stars | Installs | What it does |
| :--- | ---: | ---: | :--- |
| [pestphp/pest-plugin-evals](https://github.com/pestphp/pest-plugin-evals) `official` | 5 | 67.6K | Evals as Pest tests. LLM-as-judge and semantic assertions running in the same suite as everything else. |
...
| [mischasigtermans/laravel-toon](https://github.com/mischasigtermans/laravel-toon) | 146 | 60.2K | TOON encoder and decoder wired into Laravel. |
| [helgesverre/toon](https://github.com/HelgeSverre/toon-php) | 130 | 307.8K | Token-Oriented Object Notation. Noticeably cheaper than JSON when you are stuffing structured data into a prompt. |
| [rajentrivedi/tokenizer-x](https://github.com/rajentrivedi/tokenizer-x) | 91 | 273.6K | Counts the tokens a prompt will cost across several model families. |
...
| [cboxdk/statamic-mcp](https://github.com/cboxdk/statamic-mcp) | 36 | 30.1K | MCP server for Statamic v6, if your Laravel app happens to be a Statamic site. |
